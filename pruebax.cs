...
public class pruebax : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        */
        ...
        //Debug.Log(pinzaDerecha.ToWorldPose());

        brazoReal.position = forearm.ToWorldPose().position;
        brazoReal.rotation = forearm.ToWorldPose().rotation;
